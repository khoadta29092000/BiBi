            ...
            <Paper className='' sx={{ width: '100%', overflow: 'hidden' }}>
                ...
                >
                    ...
                    <DialogContent dividers >
                        ...
                        <div className='max-w-5xl my-5 mx-auto'>
                            <TextField className='w-96 my-5' onChange={e => setTitle(e.target.value)} defaultValue={selectedValue.quantity} autoComplete='off' id="outlined-basic" label="Quantity" variant="outlined" />
                        </div>
